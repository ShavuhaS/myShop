...
function CategoriesCard(index, name, arrayCards) {
   ...
   this.render = function () {
      ...
      currentWrapper.append(this.createCardWrapper())
   }
...
const categoriesBlock = new CategoriesCard(
   ...
   [
      {
         "image": "../images/categories/bicycle-1.png",
         "background": "../images/categories/bg-1.png",
         "title": "OFFROAD SERIES"
      },
      {
         "image": "../images/categories/bicycle-2.png",
         "background": "../images/categories/bg-2.png",
         "title": "ROAD SERIES"
      },
      {
         "image": "../images/categories/bicycle-3.png",
         "background": "../images/categories/bg-3.png",
         "title": "STREET SERIES"
      }
   ]
);
